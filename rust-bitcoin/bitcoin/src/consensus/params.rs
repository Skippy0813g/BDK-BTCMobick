...
impl Params {
    ...
    /// The BitMobick mainnet parameters.
    /// Address format identical to BTC; only genesis_hash differs.
    #[allow(deprecated)]
    pub const MOBICK: Params = Params {
        network: Network::Mobick,
    ...
    /// The LaptopMining mainnet parameters.
    /// Address format identical to BTC; only genesis_hash differs.
    #[allow(deprecated)]
    pub const LAPTOPMINING: Params = Params {
        network: Network::LaptopMining,
        bip16_time: 1333238400,
        bip34_height: 1,
        bip65_height: 1,
        bip66_height: 1,
