...
pub fn genesis_block(params: impl AsRef<Params>) -> Block {
    ...
    match params.network {
        ...
        Network::Mobick => Block {
            header: block::Header {
                version: block::Version::ONE,
                prev_blockhash: Hash::all_zeros(),
                merkle_root: sha256d::Hash::from_byte_array([
                    0x1a, 0xcc, 0x11, 0x96, 0xf1, 0xff, 0xa6, 0x2a,
                    0xb8, 0xe9, 0x0b, 0x03, 0xaf, 0x0b, 0xc8, 0x06,
                    0x94, 0x35, 0x2f, 0xa3, 0x64, 0x56, 0xfc, 0xef,
                    0x90, 0x0c, 0x8f, 0xe1, 0x3c, 0xce, 0x3e, 0x97,
                ]).into(),
                time: 1768089600,
                bits: CompactTarget::from_consensus(0x1d00ffff),
                nonce: 1949182618,
        ...
        Network::LaptopMining => Block {
            header: block::Header {
                version: block::Version::ONE,
                prev_blockhash: Hash::all_zeros(),
                merkle_root: sha256d::Hash::from_byte_array([
                    0x6c, 0xeb, 0xa4, 0x80, 0x02, 0x5e, 0x1b, 0xb4,
                    0xfa, 0xf6, 0xa1, 0xc1, 0xf5, 0x63, 0xeb, 0x49,
                    0x7f, 0x42, 0x83, 0xc8, 0x3a, 0xa1, 0x37, 0x03,
                    0xa8, 0xce, 0x13, 0x0c, 0xeb, 0xa4, 0xa2, 0xbc,
                ]).into(),
                time: 1756341124,
...
impl ChainHash {
    ...
    /// `ChainHash` for BitMobick mainnet.
    /// Genesis hash: 000000002f614682b2b4014d4948eeccf606221496572b2e7e6864404c36a163
    pub const MOBICK: Self = Self([
        0, 0, 0, 0, 47, 97, 70, 130, 178, 180, 1, 77, 73, 72, 238, 204,
        246, 6, 34, 20, 150, 87, 43, 46, 126, 104, 100, 64, 76, 54, 161, 99,
    ]);
    /// `ChainHash` for LaptopMining mainnet.
    /// Genesis hash: 20a1cb14930e9cc8f0b7e6872b0630a86c135a6903aec70b6c4e63457c7948a8
    pub const LAPTOPMINING: Self = Self([
        32, 161, 203, 20, 147, 14, 156, 200, 240, 183, 230, 135, 43, 6, 48, 168,
        108, 19, 90, 105, 3, 174, 199, 11, 108, 78, 99, 69, 124, 121, 72, 168,
    ]);
    ...
    pub fn using_genesis_block(params: impl AsRef<Params>) -> Self {
        match params.as_ref().network {
            ...
            Network::Mobick => Self::MOBICK,
            Network::LaptopMining => Self::LAPTOPMINING,
        }
    }
