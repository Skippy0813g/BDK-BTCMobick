...
impl From<Network> for NetworkKind {
    fn from(n: Network) -> Self {
        ...
        match n {
            Bitcoin | Mobick | LaptopMining => NetworkKind::Main,
...
impl Network {
    ...
    pub fn to_core_arg(self) -> &'static str {
        match self {
            ...
            Network::Mobick => "mobick",
            Network::LaptopMining => "laptopmining",
        }
    }
    ...
    pub const fn params(self) -> &'static Params {
        match self {
            ...
            Network::Mobick => &Params::MOBICK,
            Network::LaptopMining => &Params::LAPTOPMINING,
        }
    }
...
impl FromStr for Network {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s {
            ...
            "mobick" => Ok(Network::Mobick),
            "laptopmining" => Ok(Network::LaptopMining),
...
impl TryFrom<ChainHash> for Network {
    ...
    fn try_from(chain_hash: ChainHash) -> Result<Self, Self::Error> {
        match chain_hash {
            ...
            ChainHash::MOBICK => Ok(Network::Mobick),
            ChainHash::LAPTOPMINING => Ok(Network::LaptopMining),
